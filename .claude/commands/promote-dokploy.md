...
**This repo's deploy target:** Dokploy application **<app-name>** (`<app-id>`) — https://api-<app-host>
...
Check https://api-<app-host> and exercise the change itself, not just that the process is up.
