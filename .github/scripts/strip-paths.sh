...
STRIP_PATHS=".agent .agents .claude .gemini .serena _workflow-source GEMINI.md AGENTS.md CLAUDE.md SSOT.md .mcp.json .github/gemini.yaml .github/skills promote-dokploy-logs"
STRIP_GLOBS=""
